...
public class Inicio {
    ...
    private static void crearProducto() {
        ...
        Articulo nuevoProducto = new Articulo(productoNuevoNombre, productoNuevoPrecio, categoriaSeleccionada);
    ...
    private static void modificarProducto() {
        ...
        System.out.println("Ingrese la posición del producto a modificar (1-" + productos.size() + "):");
        int posicionModificar = scanner.nextInt();
        scanner.nextLine();

        if (posicionModificar < 1 || posicionModificar > productos.size()) {
            System.out.println("Posición inválida. Debe estar entre 1 y " + productos.size() + ".");
            return;
        }
    ...
    private static void verProducto() {
        ...
        System.out.println("Ingrese la posición del producto a ver (1-" + productos.size() + "):");
        ...
        System.out.println("Producto en la posición " + posicionVer + ": " + producto);
    }
    ...
    private static void eliminarProducto() {
        ...
        System.out.println("Ingrese la posición del producto a eliminar (1-" + productos.size() + "):");
    ...
    private static void modificarCategoria() {
        ...
        if (categoriaPosModificar < 1 || categoriaPosModificar > categorias.size()) {
            System.out.println("Posición inválida. Debe estar entre 1 y " + categorias.size() + ".");
            return;
        }
